...
class Jraty {
  ...
  public function get($item_id): \stdClass
  {
    $rating = new \stdClass();
  ...
  public function html($item_id, $html, $item_name='', $item_photo='', $seo=true)
  {
  ...
  public function js()
  {
  	return '<script src="'.\URL::asset('vendor/wikigods/jraty/js/jquery.raty.min.js').'" type="text/javascript" charset="utf-8"></script>';
  }

  public function js_init($params=[])
  {
    if(!$params['score']){
    ...
    if(!$params['path']){
      $params['path'] = '\'vendor/wikigods/jraty/img\'';
    }
      $options = '';
